...
CKEDITOR.dialog.add('about', function (a) {
  var a = a.lang.about, b = CKEDITOR.plugins.get('about').path + 'dialogs/' + (CKEDITOR.env.hidpi ? 'hidpi/' : '') + 'logo_ckeditor.png'; return {title: CKEDITOR.env.ie ? a.dlgTitle : a.title,
    minWidth: 390,
    minHeight: 230,
    contents: [{id: 'tab1',
      label: '',
