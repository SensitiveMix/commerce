...
CKEDITOR.dialog.add('a11yHelp', function (j) {
  var l = j.lang.a11yhelp, m = CKEDITOR.tools.getNextId(), d = {8: 'BACKSPACE',
      9: 'TAB',
      13: 'ENTER',
      16: 'SHIFT',
      17: 'CTRL',
      ...
      220: 'BACK SLASH',
      221: 'CLOSE BRAKET',
      222: 'SINGLE QUOTE'}; d[CKEDITOR.ALT] = 'ALT'; d[CKEDITOR.SHIFT] = 'SHIFT'; d[CKEDITOR.CTRL] = 'CTRL'
  var e = [CKEDITOR.ALT, CKEDITOR.SHIFT, CKEDITOR.CTRL], n = /\$\{(.*?)\}/g, q = (function () { var o = j.keystrokeHandler.keystrokes, f = {}, b; for (b in o)f[o[b]] = b; return function (b, g) { var a; if (f[g]) { a = f[g]; for (var h, i, k = [], c = 0; c < e.length; c++)i = e[c], h = a / e[c], h > 1 && h <= 2 && (a -= i, k.push(d[i])); k.push(d[a] || String.fromCharCode(a)); a = k.join('+') } else a = b; return a } }()); return {title: l.title,
    minWidth: 600,
    minHeight: 400,
    contents: [{id: 'info',
