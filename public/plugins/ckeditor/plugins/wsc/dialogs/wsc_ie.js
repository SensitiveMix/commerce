...
CKEDITOR.dialog.add('checkspell', function (a) {
  function c (a, c) { var d = 0; return function () { typeof window.doSpell === 'function' ? (typeof e !== 'undefined' && window.clearInterval(e), j(a)) : d++ == 180 && window._cancelOnError(c) } } function j (c) {
...
'none'); var b = CKEDITOR.document.getById(h); b.setStyle('display', 'block'); b.setHtml(c || a.lang.wsc.notAvailable)
    ...
    }; return {title: a.config.wsc_dialogTitle || a.lang.wsc.title,
      minWidth: 485,
      minHeight: 380,
      buttons: [CKEDITOR.dialog.cancelButton],
      onShow: function () {
        var b = this.getContentElement('general', 'content').getElement(); b.setHtml(k); b.getChild(2).setStyle('height', this._.contentSize.height + 'px'); typeof window.doSpell !== 'function' && CKEDITOR.document.getHead().append(CKEDITOR.document.createElement('script',
...
CKEDITOR.dialog.on('resize', function (a) { var a = a.data, c = a.dialog; c._.name == 'checkspell' && ((c = (c = c.getContentElement('general', 'content').getElement()) && c.getChild(2)) && c.setSize('height', a.height), c && c.setSize('width', a.width)) })
