...
(function () {
  ...
  Gridly = (function () {
    ...
    Gridly.prototype.ordinalize = function ($elements) {
      ...
      results1 = []
      for (i = j = 0, ref = $elements.length; ref >= 0 ? j <= ref : j >= ref; i = ref >= 0 ? ++j : --j) {
        $element = $($elements[i])
    ...
    Gridly.prototype.draggingMoved = function (event) {
      ...
      for (i = k = 0, ref2 = $elements.length; ref2 >= 0 ? k < ref2 : k > ref2; i = ref2 >= 0 ? ++k : --k) {
    ...
    Gridly.prototype.position = function ($element, columns) {
      ...
      height = Infinity
      column = 0
      for (i = j = 0, ref = columns.length - size; ref >= 0 ? j < ref : j > ref; i = ref >= 0 ? ++j : --j) {
    ...
    Gridly.prototype.structure = function ($elements) {
      ...
      columns = (function () {
        var j, ref, results1
        results1 = []
        for (i = j = 0, ref = this.settings.columns; ref >= 0 ? j <= ref : j >= ref; i = ref >= 0 ? ++j : --j) {
          results1.push(0)
        }
        return results1
      }.call(this))
      for (index = j = 0, ref = $elements.length; ref >= 0 ? j < ref : j > ref; index = ref >= 0 ? ++j : --j) {
    ...
    Gridly.prototype.layout = function () {
      ...
      for (index = j = 0, ref1 = $elements.length; ref1 >= 0 ? j < ref1 : j > ref1; index = ref1 >= 0 ? ++j : --j) {
        $element = $($elements[index])
    ...
    Gridly.prototype.optimize = function (originals) {
      ...
      while (originals.length > 0) {
        ...
        index = 0
        for (index = j = 0, ref = originals.length; ref >= 0 ? j < ref : j > ref; index = ref >= 0 ? ++j : --j) {
  ...
  $.fn.extend({
    gridly: function () {
      ...
      option = arguments[0], parameters = arguments.length >= 2 ? slice.call(arguments, 1) : []
      if (option == null) {
        option = {}
      }
